...
#
# Si un Chromium est déjà présent sur la machine, exportez CHROMIUM_PATH pour
# l'utiliser plutôt que d'en retélécharger un.
#
# Ces tests sont FACULTATIFS : ils ne conditionnent ni le build ni le
# déploiement. Ils vérifient, avant une mise en ligne, que les parcours réels
# fonctionnent encore.
# ---------------------------------------------------------------------------
set -uo pipefail
